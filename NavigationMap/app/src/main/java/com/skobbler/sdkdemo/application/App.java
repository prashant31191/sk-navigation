...
public class App {
     ...
     */
    public static final String MARK_PNG = ".Common/sk_logo.pngpng";
    ...
    public void copyMarkImage(Context context) {
        ...
        if (!markImage.exists()) {
            Bitmap bm = BitmapFactory.decodeResource(context.getResources(), R.drawable.sk_logo);
    ...
    public void setupMapResourcesDirPath(Context context) {
        ...
        //mapResourcesDirPath = "/storage/sdcard1/skmap" + SKMAPS_DIR;
    }
