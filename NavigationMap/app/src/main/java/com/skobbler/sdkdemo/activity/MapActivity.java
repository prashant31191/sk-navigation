...
public class MapActivity extends Activity implements SKMapSurfaceListener, SKRouteListener, SKNavigationListener,
     ...
     * Bottom button
     */
    private Button bottomButton,bottom_button_auto;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sk_activity_map);
        ...
        bottom_button_auto = (Button) findViewById(R.id.bottom_button_auto);
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.bottom_button_auto:
                if (currentMapOption == MapOption.ROUTING_AND_NAVIGATION) {
                    if (bottom_button_auto.getText().equals(getResources().getString(R.string.calculate_route))) {
                        app.launchRouteCalculation();
                    } else if (bottom_button_auto.getText().equals(getResources().getString(R.string.start_navigation))) {
                        bottom_button_auto.setText(getResources().getString(R.string.stop_navigation));
                        launchNavigationMain();
                    } else if (bottom_button_auto.getText().equals(getResources().getString(R.string.stop_navigation))) {
                        bottom_button_auto.setText(getResources().getString(R.string.calculate_route));
                        stopNavigation();
                    }
                }
                break;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.sk_search_address, menu);
        return true;
    }
    @Override
     ...
     */
    private void launchNavigationMain() {
                ...
                if (currentMapOption == MapOption.ROUTING_AND_NAVIGATION) {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            bottom_button_auto.setText(getResources().getString(R.string.start_navigation));
                        }
                    });
